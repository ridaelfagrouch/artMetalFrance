...
import {
    BodySlider1, BodySlider2, BodySlider3, BodySlider4, BodySlider5,
    BodySlider6, BodySlider7, BodySlider8, BodySlider9, BodySlider10,
    ExpertisesImage1, ExpertisesImage2, ExpertisesImage3, ExpertisesImage4,
    BodyHeaderImage1, BodyHeaderImage2, BodyHeaderImage3, BodyHeaderImage4,
    BodyHeaderImage5, BodyHeaderImage6,
} from "../../assets";
